...
const generateVerificationHtml = async url => {
  ...
  const verificationHtml = `<div style="width: 100%; display: flex; justify-content: center; align-items: center; ">${qrCodeHtml}<div style="height: 100px; display: flex; flex-direction: column; justify-content: space-between;"><div style="font-size: 8px">To verify this certificate, scan the QR code or open this link: ${link}</div><div style="font-size: 8px; text-align: right;">Powered by <a href="https://auther.org" style="color: #000000;">Auther</a>, an opensource implementation of Blockcerts</div></div></div>`
